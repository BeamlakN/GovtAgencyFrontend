        ...
        <div className="flex items-center justify-between px-3 sm:px-4 py-2.5 sm:py-3 border-b border-slate-200 bg-slate-50">
          <div>
            <h2 className="font-semibold text-slate-900 flex items-center gap-1.5 sm:gap-2 text-sm sm:text-base">
              <PencilLine size={16} className="sm:w-[18px] sm:h-[18px] text-slate-600" />
              Edit Announcement
            </h2>
            <p className="text-xs sm:text-sm text-slate-500">Update the announcement details and save changes</p>
          </div>
          <button
            onClick={onClose}
              ...
              >
                ...
                {uploadingImage ? (
                  ...
                  <div className="space-y-1.5">
                    <ImageIcon className="h-5 w-5 sm:h-6 sm:w-6 text-slate-400 mx-auto" />
